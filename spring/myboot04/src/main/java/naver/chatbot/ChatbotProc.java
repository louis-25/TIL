...
public class ChatbotProc {
  ...
  public static void main(String args[]) {
	String result = main("자주 이용하는 사이트",
...
//	String result = main("자주 이용하는 사이트",
//			"https://1f5fe6b9abc34e30b127598391e922f9.apigw.ntruss.com/custom/v1/4659/d35456e5d2b3d720652216124f3ab1f075a374ac3caa774772ce7c59536f009f", 
//			"QlJvaUxreHFyUFhCSmp2Y1l6d2VWd0pnRnR2VFdkSkM=");
...
//안드로이드용API            encodeBase64String = Base64.encodeToString(rawHmac, Base64.NO_WRAP);
...
//=> userId is a unique code for each chat user, not a fixed value, recommend use UUID. use different id for each user could help you to split chat history for users.
          ...
          obj.put("event", "send"); // 질문 - 응답(정상/실패메시지)
